...
export class ApiService {
  ...
  ForgotPassword(email: any) {
    ...
    return this.httpClient.post(`${this.baseUrl}/auth/forgot-password`, { data: email })
  }
  ...
  Otpvalue(data: any) {
    console.log("OTP");
    return this.httpClient.post(`${this.baseUrl}/auth/verify-otp-reg`, { data: data });
  }
  ...
  UpdateNumberOTP(data: any) {
    ...
    return this.httpClient.post(`${this.baseUrl}/auth/resend-otp`, { data: data });
  }

  getMenuRole(userID: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/role_management/getMenuRole?userID=` + userID);
  }
  ...
  getPurposeList(purpose_name: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getPurposeList?purpose_name=${purpose_name}`);
  }


  deleteInstituteHrd(institute_id: any, purpose_name: any) {
    return this.httpClient.post(`${this.baseUrl}/student/deleteInstituteHrd`, { "institute_id": institute_id, "purpose_name": purpose_name });
  }

  getAppliedDetails(app_id: any, user_type: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getAppliedDetails?app_id=${app_id}&user_type=${user_type}`);
  }

  getCartDetails(user_id: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getInstituteData?user_id=${user_id}`);
  }
  ...
  updateOtp(user_id: any, otp: string) {
    return this.httpClient.post(`${this.baseUrl}/admin/updateOtp`, { "user_id": user_id, "otp": otp });
  }

  updateCollegeFaculty(purpose: any, type: any, function_type: any, formData: any, id: any, user_id: any, user_name: any, app_id: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/updateCollegeFaculty`, { "purpose": purpose, "type": type, "function_type": function_type, "formData": formData, "id": id, "user_id": user_id, "user_name": user_name, "app_id": app_id });
  }
  ...
  deleteCollegeFaculty(purpose: any, dataCollegeFaculty: any, user_id: any, user_name: any, app_id: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/deleteCollegeFaculty`, { "purpose": purpose, "dataCollegeFaculty": dataCollegeFaculty, "user_id": user_id, "user_name": user_name, "app_id": app_id });
  }

  activeinactiveCollege(event: any, dataCollegeFaculty: any, user_id: any, user_name: any, app_id: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/activeinactiveCollege`, { "event": event, "dataCollegeFaculty": dataCollegeFaculty, "user_id": user_id, "user_name": user_name, "app_id": app_id });
  }

  saveNameChangedata(data: any) {

    return this.httpClient.post(`${this.baseUrl}/student/saveLetterNameChangeData`, { "data": data });
  }
  getNameChangeData() {
  ...
  deleteDocument(id: number, type: string, user_id: number) {
    return this.httpClient.delete(`${this.baseUrl}/student/deleteDocument?id=${id}&type=${type}&user_id=${user_id}`);
  }
  getFacultyLists() {
  ...
  saveInstructionalData(formData: any) {
    return this.httpClient.post(`${this.baseUrl}/student/saveInstructionalData`, formData)
  }
  ...
  updateAllInstitute(type: any, refNo: any, formData: any, app_id: any, institute_id: any, function_type: any, admin_id: any, user_email: any, user_type: any) {
    return this.httpClient.post(`${this.baseUrl}/student/updateAllInstitute`, { "type": type, "refNo": refNo, "formData": formData, "app_id": app_id, "institute_id": institute_id, "function_type": function_type, "admin_id": admin_id, "user_email": user_email, "user_type": user_type });
  }


  getInstituteData(app_id: any, purpose_name: any, institute_id: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getInstituteData?app_id=${app_id}&purpose_name=${purpose_name}&institute_id=${institute_id}`);
  }

  getHrdInfo(degree_type: any, faculty_type: any, app_id: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getHrdInfo?degree_type=${degree_type}&faculty_type=${faculty_type}&app_id=${app_id}`);
  }
  ...
  updateAllHrd(formData: any, function_type: any, degree_type: any, secondlastSem: any, lastSem: any, purpose_name: any, hrd_id: any, app_id: any, admin_id: any, admin_email: any, user_type: any) {
    return this.httpClient.post(`${this.baseUrl}/student/updateAllHrd`, { "formData": formData, "function_type": function_type, "degree_type": degree_type, "secondlastSem": secondlastSem, "lastSem": lastSem, "purpose_name": purpose_name, "hrd_id": hrd_id, "app_id": app_id, "admin_id": admin_id, "admin_email": admin_email, "user_type": user_type });
  }
  ...
  getStudentList(id: any, user_type: any, name: any, email: any, globalSearch: any, offset: any, limit: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/getStudentList?id=${id}&user_type=${user_type}&name=${name}&email=${email}&globalSearch=${globalSearch}&offset=${offset}&limit=${limit}`);
  }

  activeinactiveStudent(event: any, data: any, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/activeinactiveUser`, { "event": event, "data": data, "admin_email": admin_email });
  }

  resetPasswordByAdmin(studentData: any, user_id: any, user_name: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/resetPasswordByAdmin`, { "studentData": studentData, "user_id": user_id, "user_name": user_name });
  }

  resetDocumentByAdmin(studentData: any, user_id: any, user_name: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/resetDocumentByAdmin`, { "studentData": studentData, "user_id": user_id, "user_name": user_name });
  }

  changeNameByAdmin(firstname: any, lastname: any, student_id: any, student_app_id: any, user_id: any, user_name: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/changeNameByAdmin`, { "firstname": firstname, "lastname": lastname, "student_id": student_id, "student_app_id": student_app_id, "user_id": user_id, "user_name": user_name });
  }

  changeLocationByAdmin(studentData: any, location: any, user_id: any, user_name: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/changeLocationByAdmin`, { "studentData": studentData, "location": location, "user_id": user_id, "user_name": user_name });
  }

  getDocumentsData(student_id: any, student_app_id: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/getDocumentsData?student_id=${student_id}&student_app_id=${student_app_id}`);
  }

  deleteDocumentByAdmin(documentData: any, user_id: any, user_name: any, app_id: any, type: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/deleteDocumentByAdmin`, { "documentData": documentData, "user_id": user_id, "user_name": user_name, "app_id": app_id, "type": type });
  }
  ...
  ScanData(app_id: number, value: string,collegeid : any, education_type : any, pattern : any , faculty: any,formData: any) {
    return this.httpClient.post(`${this.baseUrl}/student/ScanData?value=${value}&app_id=${app_id}&collegeid=${collegeid}&education_type=${education_type}&pattern=${pattern}&faculty=${faculty}`, formData);
  }

  getUploadedDocuments(app_id: any) {
    return this.httpClient.get(`${this.baseUrl}/student/getUploadeddocument_student?app_id=${app_id}`);
  }
  ...
  resendApplication(user_id: any, app_id: any, type: any, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/resendApplication`, { "user_id": user_id, "app_id": app_id, "type": type, "admin_email": admin_email });
  }
  ...
  updateNotes(notes_data: any, app_id: any, user_id: any, admin_email: any, type: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/updateNotes`, { "notes_data": notes_data, "app_id": app_id, "user_id": user_id, "admin_email": admin_email, "type": type });
  }
  ...
  getUserApplication(tracker: any, status: any, app_id: any, offset: number, limit: number, name: any, email: any, globalSearch: any, purpose_search: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/getApplicationData?tracker=${tracker}&status=${status}&app_id=${app_id}&offset=${offset}&limit=${limit}&name=${name}&email=${email}&globalSearch=${globalSearch}&purpose_search=${purpose_search}`)
  }
  rejectApplications(user_id: number, app_id: number, admin_email: any, type: string) {
    return this.httpClient.post(`${this.baseUrl}/admin/rejectApplications`, { "user_id": user_id, "app_id": app_id, "admin_email": admin_email, "type": type })
  }

  verifiedApplication(user_id: number, app_id: number, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/verifiedApplication`, { "user_id": user_id, "app_id": app_id, "admin_email": admin_email })
  }

  getWesApplication(app_id: number, name: string, email: any, wesno: number, limit: number, offset: number) {
    return this.httpClient.get(`${this.baseUrl}/admin/getWesApplication?app_id=${app_id}&name=${name}&email=${email}&wesno=${wesno}&limit=${limit}&offset=${offset}`)
  }

  getEmailedApplication(app_id: any, name: any, email: any, globalSearch: any, limit: number, offset: number,) {
    return this.httpClient.get(`${this.baseUrl}/admin/getEmailedApplication?app_id=${app_id}&name=${name}&email=${email}&globalSearch=${globalSearch}&limit=${limit}&offset=${offset}`)
  }

  resendWesApplication(user_id: any, app_id: any, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/resendWesApplication`, { "user_id": user_id, "app_id": app_id, "admin_email": admin_email });
  }
  ...
  getUserDetails(user_id: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/getUserDetails?user_id=${user_id}`);
  }

  getUpdateSubAdmin(formData: any, user_id: any, type: any, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/getUpdateSubAdmin`, { "formData": formData, "user_id": user_id, "type": type, "admin_email": admin_email });
  }

  getUpdateRoles(formData: any, user_id: any, admin_email: any) {
    return this.httpClient.post(`${this.baseUrl}/admin/getUpdateRoles`, { "formData": formData, "user_id": user_id, "admin_email": admin_email });
  }

  verifyApplication(app_id: any) {
    return this.httpClient.get(`${this.baseUrl}/admin/verifyApplication?app_id=${app_id}`);
  }
  ...
  checkstepper_inner(app_id: any) {
    return this.httpClient.get(`${this.baseUrl}/student/checkstepper_inner?app_id=${app_id}`);
  }
  ...
  Register(values: any) {
    return this.httpClient.post(`${this.baseUrl}/student/register`, { "values": values });
  }
  ...
  setuserId(token: any) {
    return this.httpClient.get(`${this.baseUrl}/student/setUserId?token=${token}`);
  }
  ...
  updateProfile(data: any) {
    return this.httpClient.post(`${this.baseUrl}/student/updateProfile`, { "data": data })
  }

  changePassword(data: any) {
    return this.httpClient.post(`${this.baseUrl}/student/changePassword`, { "data": data })
  }

  forgotPasswordSendEmailToUser(email: any) {
    return this.httpClient.post(`${this.baseUrl}/student/forgotPasswordSendEmailToUser`, { "email": email });
  }
