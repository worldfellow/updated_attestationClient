...
@Component({
  ...
  [options]="collegeList"  [virtualScroll]="true" formControlName="collegeNameCtrl"
  ...
  [virtualScrollItemSize]="38" optionLabel="name" formControlName="courseNameCtrl" 
  ...
  [virtualScrollItemSize]="38" optionLabel="name"  formControlName="semYearCtrl"
